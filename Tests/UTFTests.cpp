...
constexpr const char s_U16Str[] = "";
constexpr const char s_U32Str[] = "";
...
void UTFTests()
{
...

	{
		...
		Testing::Test("UTF16 To UTF8", []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF8, UTF::EImpl::Generic>(s_U16Str, sizeof(s_U16Str) - 1, 145); });
		Testing::Test("UTF16 To UTF32", []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF32, UTF::EImpl::Generic>(s_U16Str, sizeof(s_U16Str) - 1, 236); });
		Testing::Test("UTF32 To UTF8", []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF8, UTF::EImpl::Generic>(s_U32Str, sizeof(s_U32Str) - 1, 145); });
		Testing::Test("UTF32 To UTF16", []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF16, UTF::EImpl::Generic>(s_U32Str, sizeof(s_U32Str) - 1, 144); });
		Testing::PopGroup();
		...
		if constexpr (UTF::SIMD::c_Supported)
		{
			...
			Testing::Test("UTF16 To UTF8", []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF8, UTF::EImpl::SIMD>(s_U16Str, sizeof(s_U16Str) - 1, 145); });
			Testing::Test("UTF16 To UTF32", []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF32, UTF::EImpl::SIMD>(s_U16Str, sizeof(s_U16Str) - 1, 236); });
			Testing::Test("UTF32 To UTF8", []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF8, UTF::EImpl::SIMD>(s_U32Str, sizeof(s_U32Str) - 1, 145); });
			Testing::Test("UTF32 To UTF16", []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF16, UTF::EImpl::SIMD>(s_U32Str, sizeof(s_U32Str) - 1, 144); });
			Testing::PopGroup();
		}
	}
...

	{
		...
		Testing::TimedTest("UTF16 To UTF8", reqSizeBaselines[2], []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF8, UTF::EImpl::Generic>(s_U16Str, sizeof(s_U16Str) - 1, 145); });
		Testing::TimedTest("UTF16 To UTF32", reqSizeBaselines[3], []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF32, UTF::EImpl::Generic>(s_U16Str, sizeof(s_U16Str) - 1, 236); });
		Testing::TimedTest("UTF32 To UTF8", reqSizeBaselines[4], []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF8, UTF::EImpl::Generic>(s_U32Str, sizeof(s_U32Str) - 1, 145); });
		Testing::TimedTest("UTF32 To UTF16", reqSizeBaselines[5], []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF16, UTF::EImpl::Generic>(s_U32Str, sizeof(s_U32Str) - 1, 144); });
		Testing::PopGroup();
		...
		if constexpr (UTF::SIMD::c_Supported)
		{
			...
			Testing::TimedTest("UTF16 To UTF8", reqSizeBaselines[8], []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF8, UTF::EImpl::SIMD>(s_U16Str, sizeof(s_U16Str) - 1, 145); });
			Testing::TimedTest("UTF16 To UTF32", reqSizeBaselines[9], []() { RequiredSizeTest<UTF::EEncoding::UTF16, UTF::EEncoding::UTF32, UTF::EImpl::SIMD>(s_U16Str, sizeof(s_U16Str) - 1, 236); });
			Testing::TimedTest("UTF32 To UTF8", reqSizeBaselines[10], []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF8, UTF::EImpl::SIMD>(s_U32Str, sizeof(s_U32Str) - 1, 145); });
			Testing::TimedTest("UTF32 To UTF16", reqSizeBaselines[11], []() { RequiredSizeTest<UTF::EEncoding::UTF32, UTF::EEncoding::UTF16, UTF::EImpl::SIMD>(s_U32Str, sizeof(s_U32Str) - 1, 144); });
			Testing::PopGroup();
		}
	}
